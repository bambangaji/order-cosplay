...
class GetOrderDetailDone extends StatefulWidget {
  String id_review;
  String id_outlet;
  String id_order;
  String image;
  ...
  String id_user;
  String isStatus;
  GetOrderDetailDone(  this.id_review,
      this.id_outlet,
      this.id_order,
      this.id_user,
      this.image,
      ...
      this.isStatus);
  @override
  _GetOrderDetailDoneState createState() => _GetOrderDetailDoneState();
}

class _GetOrderDetailDoneState extends State<GetOrderDetailDone> {
  String review;
  check() {
  ...
  double ratingUser = double.parse(widget.rating);
  return Scaffold(
        body: Form(
      key: _key,
