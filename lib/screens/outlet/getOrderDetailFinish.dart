...
class GetOrderDetailFinish extends StatefulWidget {
   String id_order;
  String image;
  String deadline;
  ...
  @override
  _GetOrderDetailFinishState createState() => _GetOrderDetailFinishState();
}

class _GetOrderDetailFinishState extends State<GetOrderDetailFinish> {
  var loading = false;
  ...
  _buyProduct(String id_order,String id_outlet,String id_user) async {
    print(id_order);
    // print(idUser);
    final body = {"id_order": id_order,
    "id_outlet": id_outlet,
    "id_user" : id_user};
    print(body);
    final response = await http.post(Env.acceptOrderUser, body: body);
            ...
            child: ListView(
              ...
              children: <Widget>[
                Align(
                  alignment: Alignment.center,
                  child: Text(
                    "Are you sure to reject this price?",
                    style: TextStyle(fontSize: 18.0),
                  ),
                ),
                // TextFormField(),
                      ...
                      new SizedBox(
                        ...
                        child: RaisedButton(
                          ...
                          onPressed: () {
                            ...
                            dialogBuy(widget.id_order,widget.id_user,widget.id_outlet);
                          },
                          shape: new RoundedRectangleBorder(
